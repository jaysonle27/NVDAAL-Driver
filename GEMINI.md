...
Kernel Space:
  [NVDAAL.kext]
    ...
    ├─ NVDAALChannel (GPFIFO command submission)
    ├─ NVDAALVASpace (Virtual Address Space / MMU)
...
| `Sources/NVDAALChannel.cpp` | GPFIFO channel management |
| `Sources/NVDAALVASpace.cpp` | GPU virtual memory / page tables |
| `Sources/NVDAALRegs.h` | GPU register offset definitions |
